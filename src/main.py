    ...
    for student in student_list:
        if student['student_id'] in database:
            ...
            database[student['student_id']] = {
                ...
                'street': extract_sr_student_detail(student['student_details'], 'street'),
                'city': extract_sr_student_detail(student['student_details'], 'city'),
                'state': extract_sr_student_detail(student['student_details'], 'state'),
                'zip': extract_sr_student_detail(student['student_details'], 'zip'),
