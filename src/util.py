import base64, requests, datetime, pprint, json, logging, sys, smtplib, gspread, math, time, os, google.auth, pydrive, csv, os.path, calendar, argparse
...
school_info = {
    'LCA' : {
        ...
        'individualized_report_reply': 'laustin@collegiateacademies.org',
        ...
        'seat_time': {
            ...
            'contact': True,
            'link': '',
            'contact_name': 'Linda Austin',
            'contact_email': 'laustin@collegiateacademies.org'
        }
    },
    'ASA': {
        'short_name': 'ASA',
    ...
    'GWC': {
        ...
        'attendance_letter_recipient': 'amueller@collegiateacademies.org,nmcgann@collegiateacademies.org,nlewis@collegiateacademies.org',
        'daily_attendance_email_recipient': 'amueller@collegiateacademies.org,nmcgann@collegiateacademies.org,nlewis@collegiateacademies.org',
    ...
    'OA': {
        ...
        'attendance_letter_recipient': 'bporter@collegiateacademies.org,bgilmore@collegiateacademies.org',
        'daily_attendance_email_recipient': 'bgilmore@collegiateacademies.org,pbridges@collegiateacademies.org,bporter@collegiateacademies.org,tminor@collegiateacademies.org,fantonucci@collegiateacademies.org',
